...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/SexoReg']) &gt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/SexoReg': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/SexoReg']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/SexoReg': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/CodigoPaises']) &gt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/CodigoPaises': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/CodigoPaises']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mfr/StructureDefinition/CodigoPaises': maximum cardinality of 'extension' is 1</sch:assert>
