...
## ValueSet: Tramos FONASA 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-tramos-fonasa-vs | *Version*:0.2.0 |
| Active as of 2026-03-01 | *Computable Name*:TramosFONASAVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.48.42 | |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-tramos-fonasa-vs",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113883.2.22.48.42"
  }],
  "version" : "0.2.0",
  "name" : "TramosFONASAVS",
  "title" : "Tramos FONASA",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-tramos-fonasa-cs"
    }]
  }
}
