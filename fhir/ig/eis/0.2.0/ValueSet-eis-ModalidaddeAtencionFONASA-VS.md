...
## ValueSet: Modalidad de Atención FONASA 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-ModalidaddeAtencionFONASA-VS | *Version*:0.2.0 |
| Active as of 2026-03-01 | *Computable Name*:ModalidaddeAtencionFONASAVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.48.8 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.48.8"
  }],
  "version" : "0.2.0",
