# Códigos para Países - Guía de Estandares de Información de Salud v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/StructureDefinition/eis-paises | *Version*:0.2.0 |
| Active as of 2026-08-05 | *Computable Name*:Paises |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.42.10 | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.eis|current/StructureDefinition/StructureDefinition-eis-paises.json)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.42.10"
  }],
  "version" : "0.2.0",
  "name" : "Paises",
