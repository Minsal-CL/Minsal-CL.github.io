# Especialidades y Subespecialidades Bioquímicas - Guía de Estandares de Información de Salud v0.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-especialidades-bioquimicas-vs | *Version*:0.2.0 |
| Active as of 2026-03-01 | *Computable Name*:EspecialidadesBioquimicasVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.48.18 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.48.18"
  }],
  "version" : "0.2.0",
