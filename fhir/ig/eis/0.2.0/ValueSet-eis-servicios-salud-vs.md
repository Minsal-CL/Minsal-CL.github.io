...
## ValueSet: Servicios de Salud 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-servicios-salud-vs | *Version*:0.2.0 |
| Active as of 2026-03-01 | *Computable Name*:ServiciosdeSaludVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.48.35 | |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-servicios-salud-vs",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113883.2.22.48.35"
  }],
  "version" : "0.2.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://interoperabilidad.minsal.cl/fhir/ig/eis/CodeSystem/eis-servicios-salud-cs"
    }]
  }
}
