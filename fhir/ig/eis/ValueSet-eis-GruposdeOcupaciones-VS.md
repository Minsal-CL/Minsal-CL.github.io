...
## ValueSet: Grupos de Ocupaciones 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/eis/ValueSet/eis-GruposdeOcupaciones-VS | *Version*:0.2.0 |
| Active as of 2026-03-01 | *Computable Name*:GruposdeOcupacionesVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.48.7 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.48.7"
  }],
  "version" : "0.2.0",
