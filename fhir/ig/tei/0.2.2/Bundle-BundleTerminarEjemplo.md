# Ejemplo Bundle Terminar - Tiempos de Espera Interoperable v0.2.2-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts**](artifacts.md)
* **Ejemplo Bundle Terminar**

## Example Bundle: Ejemplo Bundle Terminar
...
{
  "resourceType" : "Bundle",
  "id" : "BundleTerminarEjemplo",
  "meta" : {
    "profile" : [
      "https://interoperabilidad.minsal.cl/fhir/ig/tei/StructureDefinition/BundleTerminarLE"
    ]
  },
  "type" : "message",
  ...
  "entry" : [
    {
      ...
      "resource" : {
        ...
        "id" : "MesssageHeaderTerminar",
        "meta" : {
          "lastUpdated" : "2024-03-22T08:30:00-03:00",
          "profile" : [
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"MessageHeader_MesssageHeaderTerminar\"> </a><p class=\"res-header-id\"><b>Generated Narrative: CabeceraMensaje MesssageHeaderTerminar</b></p><a name=\"MesssageHeaderTerminar\"> </a><a name=\"hcMesssageHeaderTerminar\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\">Last updated: 2024-03-22 08:30:00-0300</p><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-MessageHeaderLE.html\">MessageHeader LE</a></p></div><p><b>event</b>: <a href=\"CodeSystem-CSTipoEventoLE.html#CSTipoEventoLE-terminar\">Tipo de Evento: terminar</a> (Terminar)</p><p><b>author</b>: <a href=\"Bundle-BundleTerminarEjemplo.html#PractitionerRole_PractitionerRoleTerminador\">PractitionerRole Terminador</a></p><h3>Sources</h3><table class=\"grid\"><tr><td style=\"display: none\">-</td><td><b>Software</b></td><td><b>Endpoint</b></td></tr><tr><td style=\"display: none\">*</td><td>SISMaule</td><td>llp:10.11.12.13:5432</td></tr></table><p><b>focus</b>: <a href=\"ServiceRequest-EjemploSolicitudInterconsultaFinalizada.html\">ServiceRequest derivación del paciente a un especialista</a></p></div>"
        },
        "eventCoding" : {
        ...
        "author" : {
          "reference" : "PractitionerRole/PractitionerRoleTerminador"
        },
        "source" : {
          "software" : "SISMaule",
    ...
    },
    {
      ...
      "resource" : {
        ...
        "id" : "PractitionerProfesionalLETerminador",
        "meta" : {
          "profile" : [
    ...
    },
    {
      ...
      "resource" : {
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"PractitionerRole_PractitionerRoleTerminador\"> </a><p class=\"res-header-id\"><b>Generated Narrative: RolProfesional PractitionerRoleTerminador</b></p><a name=\"PractitionerRoleTerminador\"> </a><a name=\"hcPractitionerRoleTerminador\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-PractitionerRoleLE.html\">PractitionerRole LE</a></p></div><p><b>active</b>: true</p><p><b>practitioner</b>: <a href=\"Bundle-BundleTerminarEjemplo.html#Practitioner_PractitionerProfesionalLETerminador\">Practitioner Gonzalo Gonzalez </a></p><p><b>organization</b>: <a href=\"Bundle-BundleTerminarEjemplo.html#Organization_OrganizationLETerminador\">Organization Centro de Referencia de Salud Miraflores</a></p><p><b>code</b>: <span title=\"Codes:{https://interoperabilidad.minsal.cl/fhir/ig/tei/CodeSystem/CSPractitionerTipoRolLE terminador}\">Terminador</span></p></div>"
        },
        "active" : true,
        "practitioner" : {
          "reference" : "Practitioner/PractitionerProfesionalLETerminador"
        },
        "organization" : {
          "reference" : "Organization/OrganizationLETerminador"
        },
        "code" : [
          {
            "coding" : [
    ...
    },
    {
      ...
      "resource" : {
        ...
        "text" : {
          "status" : "generated",
          "div" : "<div xmlns=\"http://www.w3.org/1999/xhtml\"><a name=\"Organization_OrganizationLETerminador\"> </a><p class=\"res-header-id\"><b>Generated Narrative: Organización OrganizationLETerminador</b></p><a name=\"OrganizationLETerminador\"> </a><a name=\"hcOrganizationLETerminador\"> </a><div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\"><p style=\"margin-bottom: 0px\"/><p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-OrganizationLE.html\">Organization LE</a></p></div><p><b>identifier</b>: <code>https://interoperabilidad.minsal.cl/fhir/ig/tei/CodeSystem/CSEstablecimientoDestino</code>/121343</p><p><b>name</b>: Centro de Referencia de Salud Miraflores</p></div>"
        },
        "identifier" : [
          {
