...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/ValueSet/VSModalidadAtencionCodigo | *Version*:0.1.2-ballot |
...
* [Encounter Entrevista LE](StructureDefinition-EncounterEntrevistaLE.md)
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/ValueSet/VSModalidadAtencionCodigo",
