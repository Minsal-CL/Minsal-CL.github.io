# EspecialidadMed - Lista de Espera Quirúrgica Interoperable v0.1.2-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/CodeSystem/CSEspecialidadMed | *Version*:0.1.2-ballot |
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/CodeSystem/CSEspecialidadMed",
