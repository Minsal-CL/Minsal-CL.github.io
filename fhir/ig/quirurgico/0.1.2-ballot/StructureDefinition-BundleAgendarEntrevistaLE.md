...
## Resource Profile: Bundle Agendar Entrevista LE 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/StructureDefinition/BundleAgendarEntrevistaLE | *Version*:0.1.2-ballot | |
| *Standards status:*[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 0 | *Computable Name*:BundleAgendarEntrevistaLE |
...
* Examples for this Profile: [Bundle/EjBundleAgendarEntrevista](Bundle-EjBundleAgendarEntrevista.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.quirurgico|current/StructureDefinition/BundleAgendarEntrevistaLE)
...
Other representations of profile: [CSV](StructureDefinition-BundleAgendarEntrevistaLE.csv), [Excel](StructureDefinition-BundleAgendarEntrevistaLE.xlsx), [Schematron](StructureDefinition-BundleAgendarEntrevistaLE.sch) 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/StructureDefinition/BundleAgendarEntrevistaLE",
  "version" : "0.1.2-ballot",
  "name" : "BundleAgendarEntrevistaLE",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "Entrada en el Bundle: contiene el agendamiento de la entrevista prequirúrgica.",
        "min" : 1,
        "max" : "1"
      },
      {
      ...
      },
      {
        ...
        "short" : "Agendamiento de la entrevista prequirúrgica.",
        "min" : 1,
        "type" : [
          {
            "code" : "Appointment",
