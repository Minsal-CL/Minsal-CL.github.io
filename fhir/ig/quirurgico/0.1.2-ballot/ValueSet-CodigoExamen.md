# Códigos de Examenes - Lista de Espera Quirúrgica Interoperable v0.1.2-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/ValueSet/CodigoExamen | *Version*:0.1.2-ballot |
...
```json
{
  ...
  "id" : "CodigoExamen",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/ValueSet/CodigoExamen",
