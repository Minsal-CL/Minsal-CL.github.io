...
## Resource Profile: Bundle Entrevista LE 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/StructureDefinition/BundleEntrevistaLE | *Version*:0.1.2-ballot | |
| *Standards status:*[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 0 | *Computable Name*:BundleEntrevistaLE |
...
* Examples for this Profile: [Bundle/EjBundleEntrevista](Bundle-EjBundleEntrevista.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.quirurgico|current/StructureDefinition/BundleEntrevistaLE)
...
Other representations of profile: [CSV](StructureDefinition-BundleEntrevistaLE.csv), [Excel](StructureDefinition-BundleEntrevistaLE.xlsx), [Schematron](StructureDefinition-BundleEntrevistaLE.sch) 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/StructureDefinition/BundleEntrevistaLE",
  "version" : "0.1.2-ballot",
  "name" : "BundleEntrevistaLE",
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Bundle.entry:EncuentroEntrevista",
        "path" : "Bundle.entry",
        "sliceName" : "EncuentroEntrevista",
        "short" : "Entrada en el Bundle: contiene el encuentro médico del paciente con el especialista quirúrgico.",
        "min" : 1,
        "max" : "1"
      },
      {
        "id" : "Bundle.entry:EncuentroEntrevista.fullUrl",
      ...
      {
        "id" : "Bundle.entry:EncuentroEntrevista.resource",
      ...
      {
        "id" : "Bundle.entry:EncuentroEntrevista.request",
      ...
      {
        "id" : "Bundle.entry:EncuentroEntrevista.request.method",
        "path" : "Bundle.entry.request.method",
        "patternCode" : "POST"
      },
      {
        "id" : "Bundle.entry:EncuentroEntrevista.request.url",
      ...
      },
      {
        ...
        "short" : "Entrada en el Bundle: contiene el profesional de la salud que realiza la entrevista.",
        "min" : 1,
        "max" : "1"
      },
      {
      ...
      },
      {
        ...
        "path" : "Bundle.entry.resource",
        "short" : "Profesional de la salud que realiza la entrevista.",
        "min" : 1,
        "type" : [
          {
            "code" : "Practitioner",
      ...
      },
      {
        ...
        "short" : "Entrada en el Bundle: contiene el rol del profesional de la salud en la entrevista.",
        "min" : 1,
        "max" : "1"
      },
      {
      ...
      },
      {
        ...
        "path" : "Bundle.entry.resource",
        "short" : "Rol del profesional de la salud que realiza la entrevista.",
        "min" : 1,
        "type" : [
          {
      ...
      },
      {
        ...
        "short" : "Entrada en el Bundle: contiene la solicitud de cirugía que originó la entrevista.",
        "min" : 1,
        "max" : "1"
      },
      {
      ...
      },
      {
        ...
        "path" : "Bundle.entry.resource",
        "short" : "Solicitud de cirugía que originó la entrevista actualizada.",
        "min" : 1,
        "type" : [
          {
            "code" : "ServiceRequest",
