...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/ValueSet/TipoDeObservacion | *Version*:0.1.2-ballot |
...
* [Observation Notas Clinicas LE](StructureDefinition-ObservationNotasClinicasLE.md)
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/ValueSet/TipoDeObservacion",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://interoperabilidad.minsal.cl/fhir/ig/quirurgico/CodeSystem/CSTipoObservacionMinsal"
      },
      {
