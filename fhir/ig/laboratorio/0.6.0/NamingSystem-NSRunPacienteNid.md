# RUN de Paciente (dominio NID) - Guía de Implementación FHIR - Laboratorio Clínico v0.6.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/laboratorio/NamingSystem/NSRunPacienteNid | *Version*:0.6.0 |
