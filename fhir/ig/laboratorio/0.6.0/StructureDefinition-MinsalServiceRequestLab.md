# Solicitud de Laboratorio MINSAL - Guía de Implementación FHIR - Laboratorio Clínico v0.6.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/laboratorio/StructureDefinition/MinsalServiceRequestLab | *Version*:0.6.0 |
| Draft as of 2026-09-23 | *Computable Name*:MinsalServiceRequestLab |
  ...
  "differential" : {
    ...
    },
    {
      ...
      "slicing" : {
        ...
        "description" : "Slice abierto: exige al menos la entrada SNOMED CT de laboratorio; permite entradas adicionales (p. ej. el código HL7 v2-0074 #LAB, por valor documental de mapeo).",
        "rules" : "open"
      },
      "short" : "Clasificación del servicio de laboratorio",
      "min" : 1,
      "mustSupport" : true
    },
    {
      "id" : "ServiceRequest.category:sctLabProcedure",
      "path" : "ServiceRequest.category",
      "sliceName" : "sctLabProcedure",
      "short" : "Código SNOMED CT fijo, alineado con CH LAB-Order (guía suiza de referencia de esta guía, que fija exactamente este mismo código y display para ServiceRequest.category) y con el ValueSet de ejemplo base de FHIR para ServiceRequest.category (http://hl7.org/fhir/ValueSet/servicerequest-category). Reemplaza como código principal al código HL7 v2-0074 #LAB usado hasta la versión anterior (0.5.1).",
      "min" : 1,
      "max" : "1",
