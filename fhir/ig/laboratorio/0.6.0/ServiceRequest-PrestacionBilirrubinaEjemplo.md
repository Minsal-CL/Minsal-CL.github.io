# Prestación FONASA: Bilirrubina total - Guía de Implementación FHIR - Laboratorio Clínico v0.6.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prestación FONASA: Bilirrubina total**

## Example ServiceRequest: Prestación FONASA: Bilirrubina total

Profile: [Solicitud de Laboratorio MINSAL](StructureDefinition-MinsalServiceRequestLab.md)

**identifier**: Placer Identifier/SOL-MULTIPLE-001-BIL
...
**category**: Laboratory procedure (procedure), Laboratory

**code**: Bilirrubina total
