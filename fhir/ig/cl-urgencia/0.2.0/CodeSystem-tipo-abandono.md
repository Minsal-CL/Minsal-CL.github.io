...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/CodeSystem/tipo-abandono | *Version*:0.2.0 |
| Draft as of 2026-09-23 | *Computable Name*:CSTipoAbandono |

 
Momento en que el paciente abandona voluntariamente la atención de urgencia. Códigos alineados con la versión 0.1.2-ballot de esta guía. 
...
```json
{
  ...
  "id" : "tipo-abandono",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/CodeSystem/tipo-abandono",
  "version" : "0.2.0",
  "name" : "CSTipoAbandono",
