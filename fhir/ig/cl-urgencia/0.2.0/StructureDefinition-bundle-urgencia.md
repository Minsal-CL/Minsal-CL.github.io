...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/bundle-urgencia | *Version*:0.2.0 |
| Draft as of 2026-09-23 | *Computable Name*:BundleUrgencia |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/StructureDefinition-bundle-urgencia.json)
...
```json
{
  ...
  "id" : "bundle-urgencia",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/bundle-urgencia",
  "version" : "0.2.0",
  "name" : "BundleUrgencia",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/bundle-urgencia"
      }]
    },
    {
      "id" : "Bundle.type",
