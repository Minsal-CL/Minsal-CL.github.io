# Bundle de admisión - Guía de Implementación FHIR - Urgencia (Admisión, Alta y Abandono) v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Bundle de admisión**

## Example Bundle: Bundle de admisión
...
```json
{
  ...
  "id" : "BundleAdmisionEj",
  "meta" : {
    "profile" : ["https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/bundle-admision-urgencia"]
  },
  "type" : "transaction",
  "entry" : [{
