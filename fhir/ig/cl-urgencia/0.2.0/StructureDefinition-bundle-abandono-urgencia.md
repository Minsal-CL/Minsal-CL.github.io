...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/bundle-abandono-urgencia | *Version*:0.2.0 |
| Draft as of 2026-09-23 | *Computable Name*:BundleAbandonoUrgencia |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/StructureDefinition-bundle-abandono-urgencia.json)
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/bundle-abandono-urgencia",
  "version" : "0.2.0",
