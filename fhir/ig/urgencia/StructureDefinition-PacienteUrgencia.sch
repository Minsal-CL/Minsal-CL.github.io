...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PaisOrigenMPI']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PaisOrigenMPI': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/Religion']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/Religion': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PueblosOriginariosPerteneciente']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PueblosOriginariosPerteneciente': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PueblosAfrodescendiente']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PueblosAfrodescendiente': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PueblosOriginarios']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/PueblosOriginarios': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/prevision']) &gt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/prevision': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/prevision']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/prevision': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      ...
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/SituacionCalle']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/SituacionCalle': maximum cardinality of 'extension' is 1</sch:assert>
