...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'Codigo']) &lt;= 1">extension with URL = 'Codigo': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'Otro']) &lt;= 1">extension with URL = 'Otro': maximum cardinality of 'extension' is 1</sch:assert>
