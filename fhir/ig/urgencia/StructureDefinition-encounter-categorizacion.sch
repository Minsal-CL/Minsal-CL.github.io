...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:participant">
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/titulo-profesional-categorizador']) &gt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/titulo-profesional-categorizador': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://proceso-urgencia.minsal.cl/StructureDefinition/titulo-profesional-categorizador']) &lt;= 1">extension with URL = 'http://proceso-urgencia.minsal.cl/StructureDefinition/titulo-profesional-categorizador': maximum cardinality of 'extension' is 1</sch:assert>
