# Observación Medico Legal Certificación - Atención de Urgencia Interoperable v0.1.2-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observación Medico Legal Certificación**

## Resource Profile: Observación Medico Legal Certificación 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservacionMedLegalCert | *Version*:0.1.2-ballot |
| Draft as of 2025-12-10 | *Computable Name*:ObservacionMedLegalCert |
...
* Examples for this Profile: [Observation/8bac861c-c8cc-48fa-a37c-14eeb054974f](Observation-8bac861c-c8cc-48fa-a37c-14eeb054974f.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/ObservacionMedLegalCert)
...
Other representations of profile: [CSV](StructureDefinition-ObservacionMedLegalCert.csv), [Excel](StructureDefinition-ObservacionMedLegalCert.xlsx), [Schematron](StructureDefinition-ObservacionMedLegalCert.sch) 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservacionMedLegalCert",
  "version" : "0.1.2-ballot",
  "name" : "ObservacionMedLegalCert",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternString" : "Certificación de riesgo vital o secuela grave",
        "mustSupport" : true
      },
      {
      ...
      },
      {
        ...
        "short" : "Fecha y hora de certificación de riesgo vital o secuela grave",
        "min" : 1,
        "type" : [
          {
            "code" : "dateTime"
