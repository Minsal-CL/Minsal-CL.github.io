# Consulta por Accidente - Atención de Urgencia Interoperable v0.1.2-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Consulta por Accidente**

## Extension: Consulta por Accidente 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ConsultaPorAccidente | *Version*:0.1.2-ballot |
| Draft as of 2025-12-10 | *Computable Name*:ConsultaPorAccidente |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/ConsultaPorAccidente)
...
Other representations of profile: [CSV](StructureDefinition-ConsultaPorAccidente.csv), [Excel](StructureDefinition-ConsultaPorAccidente.xlsx), [Schematron](StructureDefinition-ConsultaPorAccidente.sch) 
    ...
    "element" : [
      {
        ...
        "definition" : "Extensión que registra si la atención de urgencia se debe a un accidente."
      },
      {
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ConsultaPorAccidente"
      },
      {
