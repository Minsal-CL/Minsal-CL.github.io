# Observación Medico Legal Lesiones - Atención de Urgencia Interoperable v0.1.2-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observación Medico Legal Lesiones**

## Resource Profile: Observación Medico Legal Lesiones 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservacionMedLegalLesiones | *Version*:0.1.2-ballot |
| Draft as of 2025-12-10 | *Computable Name*:ObservacionMedLegalLesiones |
...
* Examples for this Profile: [Observation/813c8069-e56d-42a9-b2c8-91b11703c13e](Observation-813c8069-e56d-42a9-b2c8-91b11703c13e.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/ObservacionMedLegalLesiones)
...
Other representations of profile: [CSV](StructureDefinition-ObservacionMedLegalLesiones.csv), [Excel](StructureDefinition-ObservacionMedLegalLesiones.xlsx), [Schematron](StructureDefinition-ObservacionMedLegalLesiones.sch) 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservacionMedLegalLesiones",
  "version" : "0.1.2-ballot",
  "name" : "ObservacionMedLegalLesiones",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternString" : "Médico Legal Lesiones",
        "mustSupport" : true
      },
      {
      ...
      },
      {
        ...
        "short" : "Fecha y hora realización de informe de lesiones",
        "min" : 1,
        "type" : [
          {
            "code" : "dateTime"
