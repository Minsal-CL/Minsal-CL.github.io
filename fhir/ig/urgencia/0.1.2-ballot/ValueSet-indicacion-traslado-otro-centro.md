...
## ValueSet: Indicación Traslado Otro Centro 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/ValueSet/indicacion-traslado-otro-centro | *Version*:0.1.2-ballot |
| Active as of 2025-12-10 | *Computable Name*:VSIndicacionTrasladoOtroCentro |
...
* [Indicación Derivación](StructureDefinition-IndicacionDerivacion.md)
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/ValueSet/indicacion-traslado-otro-centro",
  "version" : "0.1.2-ballot",
  "name" : "VSIndicacionTrasladoOtroCentro",
