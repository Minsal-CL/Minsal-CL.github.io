# Observation Resultado Examen - Atención de Urgencia Interoperable v0.1.2-ballot
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservationResultadoExamen | *Version*:0.1.2-ballot | |
...
* Examples for this Profile: [Observation/aeb13c46-8eb3-4b8f-9bc2-e3d57024cb86](Observation-aeb13c46-8eb3-4b8f-9bc2-e3d57024cb86.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/ObservationResultadoExamen)
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservationResultadoExamen",
