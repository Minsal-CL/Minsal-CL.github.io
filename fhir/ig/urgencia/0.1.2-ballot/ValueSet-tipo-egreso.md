...
## ValueSet: Tipo Egreso 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/ValueSet/tipo-egreso | *Version*:0.1.2-ballot |
| Active as of 2025-12-10 | *Computable Name*:VSTipoEgreso |
...
```json
{
  ...
  "id" : "tipo-egreso",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/ValueSet/tipo-egreso",
