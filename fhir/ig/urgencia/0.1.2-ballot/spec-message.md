# Operaciones - Atención de Urgencia Interoperable v0.1.2-ballot
...
* Propiedad: **Método HTTP**
  * Detalle: POST
* Propiedad: **URL**
  * Detalle: https://fhir.example.com/fhir
* Propiedad: **Headers**
  * Detalle: ```Content-Type: application/json+fhir```
* Propiedad: **Body**
  * Detalle: ```{ "resourceType": "Bundle", "type": "transaction", ... // Resto del mensaje }```
