...
## Resource Profile: Observación Medico Legal Violencia Sexual 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservacionMedLegalVS | *Version*:0.1.2-ballot |
| Draft as of 2025-12-10 | *Computable Name*:ObservacionMedLegalVS |
...
* Examples for this Profile: [Observation/80d57f5d-fde9-4df3-95b8-4f223428659c](Observation-80d57f5d-fde9-4df3-95b8-4f223428659c.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/ObservacionMedLegalVS)
...
Other representations of profile: [CSV](StructureDefinition-ObservacionMedLegalVS.csv), [Excel](StructureDefinition-ObservacionMedLegalVS.xlsx), [Schematron](StructureDefinition-ObservacionMedLegalVS.sch) 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ObservacionMedLegalVS",
  "version" : "0.1.2-ballot",
  "name" : "ObservacionMedLegalVS",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "patternString" : "Médico Legal Violencia Sexual",
        "mustSupport" : true
      },
      {
      ...
      },
      {
        ...
        "short" : "Fecha y hora realización de informe de violencia sexual",
        "min" : 1,
        "type" : [
          {
            "code" : "dateTime"
