# Condition Diagnostico - Atención de Urgencia Interoperable v0.1.2-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Condition Diagnostico**

## Resource Profile: Condition Diagnostico 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ConditionDiagnosticoLE | *Version*:0.1.2-ballot | |
| *Standards status:*[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 0 | *Computable Name*:ConditionDiagnostico |
...
* Examples for this Profile: [Condition/c08c94fd-bd58-4be8-bd1d-193441b4567e](Condition-c08c94fd-bd58-4be8-bd1d-193441b4567e.md) and [Condition/e27704ff-fa1a-4750-9d23-36ce567f35b0](Condition-e27704ff-fa1a-4750-9d23-36ce567f35b0.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.urgencia|current/StructureDefinition/ConditionDiagnosticoLE)
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/StructureDefinition/ConditionDiagnosticoLE",
  "version" : "0.1.2-ballot",
  "name" : "ConditionDiagnostico",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Condition.code",
        "path" : "Condition.code",
        "short" : "Código correspondiente al diagnóstico realizado por el médico",
        "min" : 1,
        "binding" : {
          "strength" : "required",
          "valueSet" : "https://interoperabilidad.minsal.cl/fhir/ig/urgencia/ValueSet/VSTerminologiasDiag"
        }
      },
      {
      ...
      },
      {
        ...
        "short" : "Descripcion en texto libre correspondiente al diagnóstico realizado por el médico",
        "mustSupport" : true
      },
      {
      ...
      },
      {
        ...
        "short" : "Profesional que registra la condición",
        "min" : 1,
        "type" : [
          {
            "code" : "Reference",
