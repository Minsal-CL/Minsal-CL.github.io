# Perfil de Bundle: Generar Notificación Obligatoria - Repositorio de Reportes de Biopsias Oncológicas v0.3.0-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perfil de Bundle: Generar Notificación Obligatoria**

## Resource Profile: Perfil de Bundle: Generar Notificación Obligatoria 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-bundle-generar-notificacion | *Version*:0.3.0-draft | |
...
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.42.4 | | |

 
Perfil de Bundle que contiene los recursos necesarios para generar la notificación oncológica por anatomía patológica y cargarlos en el repositorio. 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.42.4"
  }],
  "version" : "0.3.0-draft",
