# Set de Valores Morfología - Repositorio de Reportes de Biopsias Oncológicas v0.3.0-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores Morfología**

## ValueSet: Set de Valores Morfología 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-morfologicosct-cieo-VS | *Version*:0.3.0-draft |
| Draft as of 2026-08-20 | *Computable Name*:MorfologicoCIEOVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.48.9 | |
...
Set de valores utilizados para morfologías en CIE-O 3.2 Morfológico 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.48.9"
  }],
  "version" : "0.3.0-draft",
  "name" : "MorfologicoCIEOVS",
