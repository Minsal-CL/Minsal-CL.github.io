...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.0-draft/Observation-r2bo-estadificacion-tnm-ex.html");
  else if (id == "r2bo-tnm-categoria-tumor-primario-ex")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.0-draft/Observation-r2bo-tnm-categoria-tumor-primario-ex.html");
  else if (id == "r2bo-tnm-categoria-nodo-regional-ex")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.0-draft/Observation-r2bo-tnm-categoria-nodo-regional-ex.html");
  else if (id == "r2bo-tnm-categoria-metastasis-distantel-ex")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.0-draft/Observation-r2bo-tnm-categoria-metastasis-distantel-ex.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.3.0-draft\crobservation.asp) .
</body>
</html>
