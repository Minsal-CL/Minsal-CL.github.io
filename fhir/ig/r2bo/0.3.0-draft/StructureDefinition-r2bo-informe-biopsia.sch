...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-Addenda-Reportebiopsia']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-Addenda-Reportebiopsia': maximum cardinality of 'extension' is 1</sch:assert>
