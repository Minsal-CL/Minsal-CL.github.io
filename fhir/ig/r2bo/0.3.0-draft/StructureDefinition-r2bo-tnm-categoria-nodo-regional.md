# Perfil de Categoria TNM Nodos Regional - Repositorio de Reportes de Biopsias Oncológicas v0.3.0-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perfil de Categoria TNM Nodos Regional**

## Resource Profile: Perfil de Categoria TNM Nodos Regional 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-tnm-categoria-nodo-regional | *Version*:0.3.0-draft | |
...
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.42.16 | | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.r2bo|current/StructureDefinition/StructureDefinition-r2bo-tnm-categoria-nodo-regional.json)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.42.16"
  }],
  "version" : "0.3.0-draft",
