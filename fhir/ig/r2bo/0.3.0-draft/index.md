# Repositorio de Reportes de Biopsias Oncológicas del Ministerio de Salud - Repositorio de Reportes de Biopsias Oncológicas v0.3.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ImplementationGuide/hl7.fhir.cl.minsal.r2bo | *Version*:0.3.0-draft |
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-r2bo-observaciones-NeoAdyuvancia-VS.html"
      }],
      "reference" : {
