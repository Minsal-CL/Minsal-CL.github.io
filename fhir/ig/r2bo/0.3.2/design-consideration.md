# Consideraciones de Diseño - Repositorio de Reportes de Biopsias Oncológicas v0.3.2
...
La relación más importante comienza desde el recurso DiagnosticReport [R2BOInformeBiopsia](StructureDefinition-r2bo-informe-biopsia.md) desde la perspectiva REST.
