# Set de Valores de Caracteristicas del Margen Quirurgico - Repositorio de Reportes de Biopsias Oncológicas v0.1.1-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores de Caracteristicas del Margen Quirurgico**

## ValueSet: Set de Valores de Caracteristicas del Margen Quirurgico (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-caracteristicas-margen-quirurgico-VS | *Version*:0.1.1-ballot |
| Draft as of 2025-12-12 | *Computable Name*:CaracteristicasMargenQuirurgicoVS |
...
Set de valores del nivel de compromiso del margen quiurgico en un reporte de biopsia 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-caracteristicas-margen-quirurgico-VS",
  "version" : "0.1.1-ballot",
  "name" : "CaracteristicasMargenQuirurgicoVS",
