# Observacion de Ejemplo: Invasión Vascular - Repositorio de Reportes de Biopsias Oncológicas v0.1.1-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observacion de Ejemplo: Invasión Vascular**

## Example Observation: Observacion de Ejemplo: Invasión Vascular
...
**code**: Venous.large vessel.invasion [Identifier] in Specimen by CAP cancer protocols
