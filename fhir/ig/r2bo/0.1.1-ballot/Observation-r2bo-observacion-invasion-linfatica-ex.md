# Observacion de Ejemplo: Invasión Linfatica - Repositorio de Reportes de Biopsias Oncológicas v0.1.1-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observacion de Ejemplo: Invasión Linfatica**

## Example Observation: Observacion de Ejemplo: Invasión Linfatica
...
**code**: Lymphatic.small vessel.invasion [Identifier] in Specimen by CAP cancer protocols
