# Perfil de Bundle: Generar Notificación Obligatoria - Repositorio de Reportes de Biopsias Oncológicas v0.1.1-ballot
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-bundle-generar-notificacion | *Version*:0.1.1-ballot | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.cl.minsal.r2bo|current/StructureDefinition/r2bo-bundle-generar-notificacion)
