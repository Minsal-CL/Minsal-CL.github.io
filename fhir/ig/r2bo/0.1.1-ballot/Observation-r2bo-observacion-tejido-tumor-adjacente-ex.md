# Observacion de Ejemplo: Tejido Tumoral Adjacente - Repositorio de Reportes de Biopsias Oncológicas v0.1.1-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Observacion de Ejemplo: Tejido Tumoral Adjacente**

## Example Observation: Observacion de Ejemplo: Tejido Tumoral Adjacente

Profile: [Perfil de Observacion Tejido No Tumoral Adyacente](StructureDefinition-r2bo-observacion-tejido-no-tumor-adyacente.md)
...
**code**: Site of adjacent organ or tissue involvement Cancer specimen
...
**value**: Se observa tejido tumoral en tejido adyacente
...
```json
{
  ...
  "id" : "r2bo-observacion-tejido-tumor-adjacente-ex",
  "meta" : {
    "profile" : [
