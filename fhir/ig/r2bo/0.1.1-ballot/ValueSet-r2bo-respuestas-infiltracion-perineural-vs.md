# Set de Valores Para Hallazgos de Infiltración Perineural - Repositorio de Reportes de Biopsias Oncológicas v0.1.1-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores Para Hallazgos de Infiltración Perineural**

## ValueSet: Set de Valores Para Hallazgos de Infiltración Perineural (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-respuestas-infiltracion-perineural-vs | *Version*:0.1.1-ballot |
| Draft as of 2025-12-12 | *Computable Name*:RespuestasInfiltracionPerineuralVS |
...
Posibles hallazgos de infiltración perineural en un reporte de biopsia. Este conjunto de valores decienden del concepto: 396394004 hallazgo relacionado con invasión perineural 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-respuestas-infiltracion-perineural-vs",
  "version" : "0.1.1-ballot",
  "name" : "RespuestasInfiltracionPerineuralVS",
