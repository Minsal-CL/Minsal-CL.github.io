# Set de Valores para Topografía - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-topografica-cieo-VS | *Version*:0.2.0-draft |
| Draft as of 2026-06-24 | *Computable Name*:TopograficaSnomedCIEOVS |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "valueSet" : ["https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-topografica-VS"]
    },
    {
