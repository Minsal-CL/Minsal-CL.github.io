# Ejemplo del Documento un Informe de Anatomía Patológica - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-bundle-documento"]
  },
  "identifier" : {
