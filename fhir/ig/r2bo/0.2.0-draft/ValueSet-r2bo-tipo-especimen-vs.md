# Set de Valores de los Tipos de Especimen - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores de los Tipos de Especimen**

## ValueSet: Set de Valores de los Tipos de Especimen (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-tipo-especimen-vs | *Version*:0.2.0-draft |
| Draft as of 2026-06-24 | *Computable Name*:TipoEspecimenVS |
