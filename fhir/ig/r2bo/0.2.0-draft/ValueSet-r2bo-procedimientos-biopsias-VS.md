# Set de Valores Para Procedimientos - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores Para Procedimientos**

## ValueSet: Set de Valores Para Procedimientos (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-procedimientos-biopsias-VS | *Version*:0.2.0-draft |
| Draft as of 2026-06-24 | *Computable Name*:ProcedimientosBiopsiaVS |
