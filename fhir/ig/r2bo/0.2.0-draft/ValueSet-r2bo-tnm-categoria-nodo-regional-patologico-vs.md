# Set de Valores Categoría TNM Patológico Nodos Regional - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores Categoría TNM Patológico Nodos Regional**

## ValueSet: Set de Valores Categoría TNM Patológico Nodos Regional (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-tnm-categoria-nodo-regional-patologico-vs | *Version*:0.2.0-draft |
| Draft as of 2026-06-24 | *Computable Name*:TNMCategoriaPatologicoNodosRegionalVS |
