...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-morfologicosct-cieo-VS | *Version*:0.2.0-draft |
| Draft as of 2026-06-24 | *Computable Name*:MorfologicoSnomedCIEOVS |
...
Set de valores utilizados para morfologías, estos pueden ser mapeados de Snomed CT a la CIE-O 3 Morfológico o ser usado directamente en CIE-O 3 Morfológico 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-morfologicosct-cieo-VS",
  "version" : "0.2.0-draft",
  "name" : "MorfologicoSnomedCIEOVS",
  ...
  "compose" : {
    "include" : [{
      "valueSet" : ["https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-morfologico-VS"]
    },
    {
