# Set de Valores de los Reportes de Biopsia - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores de los Reportes de Biopsia**

## ValueSet: Set de Valores de los Reportes de Biopsia (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-reporte-biopsia-vs | *Version*:0.2.0-draft |
| Draft as of 2026-06-24 | *Computable Name*:ReporteBiopsiaVS |
