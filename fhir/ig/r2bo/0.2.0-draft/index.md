# Repositorio de Reportes de Biopsias Oncológicas del Ministerio de Salud - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ImplementationGuide/hl7.fhir.cl.minsal.r2bo | *Version*:0.2.0-draft |
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/r2bo-morfologico-VS"
      },
      "name" : "Set de Valores Morfología",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/r2bo-topografica-VS"
      },
      "name" : "Set de Valores para Topografía en Snomed CT",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/r2bo-snomed-hallazgos-clinicos-VS"
      },
      "name" : "ValueSet Para Hallazgos Clínicos en Snomed CT",
