# Perfil de la Morfología y Topología del Tumor - Repositorio de Reportes de Biopsias Oncológicas v0.2.0-draft
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-tumor | *Version*:0.2.0-draft | |
...
* Refer to this Profile: [Perfil de la Cabecera del Documento de Biopsía](StructureDefinition-r2bo-composition-biopsia.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.r2bo|current/StructureDefinition/StructureDefinition-r2bo-tumor.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "BodyStructure.morphology.extension",
      "path" : "BodyStructure.morphology.extension",
      "short" : "Grado de diferenciación tumoral"
    },
    {
      "id" : "BodyStructure.morphology.extension:gradoDiferenciacion",
      "path" : "BodyStructure.morphology.extension",
