# Set de Valores Para los Sitios del Cuerpo - Repositorio de Reportes de Biopsias Oncológicas v0.3.1-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores Para los Sitios del Cuerpo**

## ValueSet: Set de Valores Para los Sitios del Cuerpo 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-estructuras-anatomicas-VS | *Version*:0.3.1-draft |
| Draft as of 2026-09-07 | *Computable Name*:EstructuraAnatomicaVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.48.4 | |
...
Set de valores para las distintas estructuras corporales de donde se obtienen las muestras 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-estructuras-anatomicas-VS",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.48.4"
  }],
  "version" : "0.3.1-draft",
  "name" : "EstructuraAnatomicaVS",
