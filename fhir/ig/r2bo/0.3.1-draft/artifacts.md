# Artifacts Summary - Repositorio de Reportes de Biopsias Oncológicas v0.3.1-draft
...
| [Perfil de Para Todas las Observaciones de los Resultados de Biopsias](StructureDefinition-r2bo-resultados-reporte-biopsia.md) | Perfil para todas las observaciones de los resultados de biopsias |
...
| | |
| :--- | :--- |
| [Perfil de Bundle: Generar Notificación Obligatoria](StructureDefinition-r2bo-bundle-generar-notificacion.md) | Perfil de Bundle que contiene los recursos necesarios para generar la notificación oncológica por anatomía patológica y cargarlos en el repositorio. |
...
| [Set de Valores CIE-11 Códigos de Extensión Histopatológicos](ValueSet-r2bo-morfologicos-cie11-VS.md) | Set de valores utilizados para CIE-11 Códigos de Extensión Histopatológicos par ser usado en la morfología de neoplasias |
...
| [Set de Valores para Topografía](ValueSet-r2bo-topografica-cie11-VS.md) | Set de valores utilizados para la topografía de la CIE-11 para Anatomía y topografía |
| [Set de Valores para Topografía según la CIE-O 3.2](ValueSet-r2bo-topografica-cieo-VS.md) | Set de valores utilizados para la topografía de la CIE-O 3.2 Tográfico |
| [Set de Valores para la Estadificación](ValueSet-r2bo-Estadificacion-patologico-vs.md) | Set de valores utilizados para la estadificación |
| [ValueSet Para Hallazgos Clínicos](ValueSet-r2bo-hallazgos-clinicos-cie10-VS.md) | Este ValueSet contiene los códigos que representan las neoplasias de la CIE 10 |
| [ValueSet Para Hallazgos Clínicos de la CIE 11 para neoplasias](ValueSet-r2bo-hallazgos-clinicos-cie11-VS.md) | Este ValueSet contiene los códigos de la CIE 11 para hallazgos clínicos de neoplasias, que son utilizados en la definición de perfiles de recursos FHIR para la interoperabilidad en salud. |
