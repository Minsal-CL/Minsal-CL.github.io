...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.1-draft/PractitionerRole-ProfesionalHospital.html");
  else if (id == "r2bo-anatopatologo-hospital")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.1-draft/PractitionerRole-r2bo-anatopatologo-hospital.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.3.1-draft\crpractitionerrole.asp) .
</body>
</html>
