...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.1-draft/CapabilityStatement-r2bo-minsal-consumidor.html");
  else if (id == "r2bo-minsal-analisis")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.1-draft/CapabilityStatement-r2bo-minsal-analisis.html");
  else if (id == "r2bo-minsal-server")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.1-draft/CapabilityStatement-r2bo-minsal-server.html");
  else if (id == "r2bo-minsal-cliente-informe")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/r2bo/0.3.1-draft/CapabilityStatement-r2bo-minsal-cliente-informe.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.3.1-draft\crcapabilitystatement.asp) .
</body>
</html>
