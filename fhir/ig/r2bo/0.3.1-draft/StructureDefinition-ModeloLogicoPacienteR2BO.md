# Modelo Logico De un Paciente del R2BO - Repositorio de Reportes de Biopsias Oncológicas v0.3.1-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/ModeloLogicoPacienteR2BO | *Version*:0.3.1-draft |
| Draft as of 2026-09-07 | *Computable Name*:PacienteR2BOLogico |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.42.2 | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.r2bo|current/StructureDefinition/StructureDefinition-ModeloLogicoPacienteR2BO.json)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.42.2"
  }],
  "version" : "0.3.1-draft",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "mapping" : [{
        "identity" : "r2bo-paciente-nid-mapping",
        "map" : "Patient.extension[SexoBiologico]",
