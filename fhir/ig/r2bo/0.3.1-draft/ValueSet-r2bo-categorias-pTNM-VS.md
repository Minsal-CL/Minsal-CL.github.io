# Set de Valores para Categorias pTNM - Repositorio de Reportes de Biopsias Oncológicas v0.3.1-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores para Categorias pTNM**

## ValueSet: Set de Valores para Categorias pTNM 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-categorias-pTNM-VS | *Version*:0.3.1-draft |
| Draft as of 2026-09-07 | *Computable Name*:CategoriaspTNMVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.48.2 | |
...
Set de valores para las categorias para el TNM patológico 
...
```json
{
  ...
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-categorias-pTNM-VS",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.48.2"
  }],
  "version" : "0.3.1-draft",
