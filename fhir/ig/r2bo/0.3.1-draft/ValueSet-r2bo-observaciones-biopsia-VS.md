# Set de Valores para Observaciones Biopsia - Repositorio de Reportes de Biopsias Oncológicas v0.3.1-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Set de Valores para Observaciones Biopsia**

## ValueSet: Set de Valores para Observaciones Biopsia 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/ValueSet/r2bo-observaciones-biopsia-VS | *Version*:0.3.1-draft |
| Draft as of 2026-09-07 | *Computable Name*:ObservacionesBiopsiaVS |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.48.11 | |
...
* [Perfil de Para Todas las Observaciones de los Resultados de Biopsias](StructureDefinition-r2bo-resultados-reporte-biopsia.md)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.48.11"
  }],
  "version" : "0.3.1-draft",
