# Modelo Lógico de Informe Patológico del R2BO - Repositorio de Reportes de Biopsias Oncológicas v0.3.1-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/ModeloLogicoInformePatologicoR2BO | *Version*:0.3.1-draft |
| Draft as of 2026-09-07 | *Computable Name*:InformePatologicoR2BOLogico |
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.42.1 | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.r2bo|current/StructureDefinition/StructureDefinition-ModeloLogicoInformePatologicoR2BO.json)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.42.1"
  }],
  "version" : "0.3.1-draft",
  ...
  "differential" : {
    ...
    {
      "id" : "ModeloLogicoInformePatologicoR2BO.identificadorInforme",
      "path" : "ModeloLogicoInformePatologicoR2BO.identificadorInforme",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/ModeloLogicoPacienteR2BO"]
      }],
      "isSummary" : true,
      "mapping" : [{
        "identity" : "informe-modelo-logico-map",
    ...
    {
      "id" : "ModeloLogicoInformePatologicoR2BO.solicitud.antecedentesClinicosRelevantes",
      "path" : "ModeloLogicoInformePatologicoR2BO.solicitud.antecedentesClinicosRelevantes",
      "short" : "corresponde a la información clínica relevante del paciente que se debe considerar para el análisis de la muestra, como antecedentes médicos, síntomas actuales, tratamientos previos o cualquier otro dato que pueda influir en la interpretación de los resultados.",
      "definition" : "corresponde a la información clínica relevante del paciente que se debe considerar para el análisis de la muestra, como antecedentes médicos, síntomas actuales, tratamientos previos o cualquier otro dato que pueda influir en la interpretación de los resultados.",
      "min" : 0,
      "max" : "*",
      "type" : [{
        "code" : "string"
    ...
    {
      "id" : "ModeloLogicoInformePatologicoR2BO.muestra",
      "path" : "ModeloLogicoInformePatologicoR2BO.muestra",
      "short" : "Corresponde a la muestra de tejido o células que se analiza en el laboratorio de anatomía patológica, la cual contiene las características macroscópicas y microscópicas del tejido extraído.",
      "definition" : "Corresponde a la muestra de tejido o células que se analiza en el laboratorio de anatomía patológica, la cual contiene las características macroscópicas y microscópicas del tejido extraído.",
      "min" : 1,
      "max" : "1",
      "type" : [{
        "code" : "BackboneElement"
    ...
    {
      "id" : "ModeloLogicoInformePatologicoR2BO.muestra.identificadorDeMuestra",
      "path" : "ModeloLogicoInformePatologicoR2BO.muestra.identificadorDeMuestra",
      "short" : "Cantidad de muestras analizadas.",
      "definition" : "Cantidad de muestras analizadas.",
      "min" : 1,
      "max" : "1",
