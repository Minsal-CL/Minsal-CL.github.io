# Perfil de Origen para las Categorías T, N, M (Abstracto) - Repositorio de Reportes de Biopsias Oncológicas v0.3.1-draft

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Perfil de Origen para las Categorías T, N, M (Abstracto)**

## Resource Profile: Perfil de Origen para las Categorías T, N, M (Abstracto) ( Abstract ) 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/r2bo/StructureDefinition/r2bo-categoria-tnm | *Version*:0.3.1-draft | |
...
| *Other Identifiers:*OID:2.16.840.1.113883.2.22.40.8.42.5 | | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.cl.minsal.r2bo|current/StructureDefinition/StructureDefinition-r2bo-categoria-tnm.json)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.2.22.40.8.42.5"
  }],
  "version" : "0.3.1-draft",
  "name" : "CategoriaTNM",
