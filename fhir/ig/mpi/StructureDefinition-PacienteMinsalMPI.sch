...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PaisOrigenMPI']) &gt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PaisOrigenMPI': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PaisOrigenMPI']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PaisOrigenMPI': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/Religion']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/Religion': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/SexoBiologico']) &gt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/SexoBiologico': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/SexoBiologico']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/SexoBiologico': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/IdentidadDeGenero']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/IdentidadDeGenero': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosOriginariosPerteneciente']) &gt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosOriginariosPerteneciente': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosOriginariosPerteneciente']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosOriginariosPerteneciente': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosAfrodescendiente']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosAfrodescendiente': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosOriginarios']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/PueblosOriginarios': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address">
      ...
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/SituacionCalle']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/mpi/StructureDefinition/SituacionCalle': maximum cardinality of 'extension' is 1</sch:assert>
