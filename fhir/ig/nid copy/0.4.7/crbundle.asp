...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.7/Bundle-EjemploBusquedaProf.html");
  else if (id == "EjemploBusquedaAdm")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.7/Bundle-EjemploBusquedaAdm.html");
  else if (id == "EjemploBusqueda")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.7/Bundle-EjemploBusqueda.html");
  else if (id == "EjemploBusquedaMatch")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.7/Bundle-EjemploBusquedaMatch.html");
  else if (id == "EjemploBusquedaOrg")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.7/Bundle-EjemploBusquedaOrg.html");
  else if (id == "EjemploBusquedaMatchOutcomeOperation")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.7/Bundle-EjemploBusquedaMatchOutcomeOperation.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /0.4.7/crbundle.asp) .
</body>
</html>
