...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.5/Parameters-ParametroEntradaIhe-PDQm.html");
  else if (id == "ParametroEntradaIhe-PIXm")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.5/Parameters-ParametroEntradaIhe-PIXm.html");
  else if (id == "ParametroSalidaIhe-PIXm")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.5/Parameters-ParametroSalidaIhe-PIXm.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /0.4.5/crparameters.asp) .
</body>
</html>
