...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.5/Observation-EjemploNivelEducacional.html");
  else if (id == "EjemploOcupacion")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.5/Observation-EjemploOcupacion.html");
  else if (id == "EjemploSituacionDiscapacidad")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.5/Observation-EjemploSituacionDiscapacidad.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from /0.4.5/crobservation.asp) .
</body>
</html>
