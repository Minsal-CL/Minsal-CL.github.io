...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSUNivelAprob | *Version*:0.4.8 |
...
* Include all codes defined in [`https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSUNivelAprob`](CodeSystem-CSUNivelAprob.md)version 📦0.4.8
