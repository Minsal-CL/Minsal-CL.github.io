# MINSAL Paciente Busqueda - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/StructureDefinition/MINSALPacienteBusqueda | *Version*:0.4.8 | |
...
* Use this Profile: [MINSAL Parámetros Entrada $match PDQM](StructureDefinition-ParametrosEntradaPDQmMpi.md)
