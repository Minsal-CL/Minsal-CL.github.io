# Casos de Uso y Transacciones "Directorio de Proveedores de Atención Médica" - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8

* [**Table of Contents**](toc.md)
* **Casos de Uso y Transacciones "Directorio de Proveedores de Atención Médica"**
...
Diagrama Actores HPD (Fuente: Perfil IHE)
...
```
GET /Practitioner?_profile=[uriPerfil]&birthdate=1991-04-01
...
```
GET /Practitioner?_profile=[uriPerfil]&family=Gonzalez
...
```
GET /Practitioner?_profile=[uriPerfil]&given=María
...
La respuesta del sistema que suple es un recurso [Bundle](StructureDefinition-BundleSearchProfHPD.md) de tipo **SearchSet** en donde se indica la cantidad de recursos encontrados con los parámetros coincidentes y cada uno de los éstos incluídos como entrada. 

```
GET /Practitioner?_profile=StructureDefinition/MINSALPrestadorProfesional&identifier=19949350-7&birthdate=1991-04-01&given=María&family=Gonzalez
...
```
GET /Organization?name=Hospital
...
La respuesta del sistema que suple es un recurso [Bundle](StructureDefinition-BundleSearchINSHPD.md) de tipo **SearchSet** en donde se indica la cantidad de recursos encontrados con los parámetros coincidentes y cada uno de los éstos incluídos como entrada. 

```
GET /Organization?identifier=120101&name=Hospital
