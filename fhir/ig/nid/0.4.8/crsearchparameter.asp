...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.8/SearchParameter-mpi-paciente-segundoApellido.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.4.8\crsearchparameter.asp) .
</body>
</html>
