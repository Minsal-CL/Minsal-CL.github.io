# Tramos de FONASA - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSTramosFONASA | *Version*:0.4.8 |
...
* Include all codes defined in [`https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSTramosFONASA`](CodeSystem-CSTramosFONASA.md)version 📦0.4.8
