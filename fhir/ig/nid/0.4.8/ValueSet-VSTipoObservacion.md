# Tipo de Observacion - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSTipoObservacion | *Version*:0.4.8 |
...
* Include all codes defined in [`https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSTipoObservacion`](CodeSystem-CSTipoObservacion.md)version 📦0.4.8
