# Especificaciones de Negocio "Índice Maestro de Pacientes" - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8

* [**Table of Contents**](toc.md)
* **Especificaciones de Negocio "Índice Maestro de Pacientes"**
