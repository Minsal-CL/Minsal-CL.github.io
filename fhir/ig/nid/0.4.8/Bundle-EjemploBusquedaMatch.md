# Ejemplo de una Busqueda Match - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8

* [**Table of Contents**](toc.md)
* [**Artefactos Generados**](artifacts.md)
* **Ejemplo de una Busqueda Match**

## Example Bundle: Ejemplo de una Busqueda Match

Profile: [MINSAL Bundle Resultado Operación Match](StructureDefinition-BundleSearchMPIMatch.md)

Bundle EjemploBusquedaMatch of type searchset

-------

Entry 1 - fullUrl = https://interoperabilidad.minsal.cl/fhir/ig/nid/Patient/AC1696435881599

Búsqueda:Mode = match,Score = 0.7
        ...
        "address" : [
          {
            ...
            "use" : "home",
            "line" : ["Calle Los Cedros 1234, Casa 15"],
            "_city" : {
              "extension" : [
                {
