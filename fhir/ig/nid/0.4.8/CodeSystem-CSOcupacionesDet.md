# Ocupaciones Detalladas - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8

* [**Table of Contents**](toc.md)
* [**Artefactos Generados**](artifacts.md)
* **Ocupaciones Detalladas**

## CodeSystem: Ocupaciones Detalladas 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSOcupacionesDet | *Version*:0.4.8 |
| Active as of 2022-01-18 | *Computable Name*:CSOcupacionesDet |
...
* [VSOcupacionesDet](ValueSet-VSOcupacionesDet.md)
...
```json
{
  ...
  "id" : "CSOcupacionesDet",
  "url" : "https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSOcupacionesDet",
  "version" : "0.4.8",
  "name" : "CSOcupacionesDet",
