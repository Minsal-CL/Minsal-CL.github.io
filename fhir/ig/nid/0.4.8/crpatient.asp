...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.8/Patient-MinsalPacienteEjemplo.html");
  else if (id == "EjemploPacienteBusqueda")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.8/Patient-EjemploPacienteBusqueda.html");
  else if (id == "DuplicadoMPIPaciente")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.8/Patient-DuplicadoMPIPaciente.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.4.8\crpatient.asp) .
</body>
</html>
