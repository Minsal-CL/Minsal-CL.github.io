# MINSAL Paciente - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/StructureDefinition/MINSALPaciente | *Version*:0.4.8 | |
...
```json
{
  ...
  "extension" : [
    ...
    },
    {
      ...
      "valueCanonical" : "https://profiles.ihe.net/ITI/PIXm/StructureDefinition/IHE.PIXm.Patient"
    }
  ],
  ...
  "abstract" : false,
  "type" : "Patient",
  "baseDefinition" : "https://hl7chile.cl/fhir/ig/clcore/StructureDefinition/CorePacienteCl|1.9.4",
        ...
        "type" : [
          {
            ...
            "code" : "Reference",
            "targetProfile" : [
              "https://hl7chile.cl/fhir/ig/clcore/StructureDefinition/CorePacienteCl|1.9.4",
