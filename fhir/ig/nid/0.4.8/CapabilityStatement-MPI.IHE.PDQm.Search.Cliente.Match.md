# Indice Maestro Paciente: "Cliente Buscador de Datos Demográficos (PDQm) con implementación de Match" - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/CapabilityStatement/MPI.IHE.PDQm.Search.Cliente.Match | *Version*:0.4.8 | |
...
* [https://profiles.ihe.net/ITI/PDQm/ImplementationGuide/ihe.iti.pdqm](https://profiles.ihe.net/ITI/PDQm/3.1.0/index.html)
