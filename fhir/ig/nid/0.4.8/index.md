# Inicio - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.8
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ImplementationGuide/hl7.fhir.cl.minsal.nid | *Version*:0.4.8 |
| Draft as of 2025-11-28 | *Computable Name*:MinsalNucleoInteroperabilidadDatos |
...
```json
{
  ...
  "dependsOn" : [
    ...
    {
      "id" : "hl7_fhir_cl_clips",
      "uri" : "https://hl7chile.cl/fhir/ig/clips/ImplementationGuide/hl7.fhir.cl.clips",
      "packageId" : "hl7.fhir.cl.clips",
      "version" : "0.4.0"
    },
    {
      "id" : "IHE_PIXm",
  ...
  "definition" : {
    ...
    "resource" : [
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/ParametrosEntradaPixmMpi"
        },
        "name" : "MINSAL Parametros Entrada PIXm",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/ParametrosEntradaPDQmMpi"
        },
        "name" : "MINSAL Parámetros Entrada $match PDQM",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/ParametrosSalidaPixmMpi"
        },
        "name" : "MINSAL Parámetros Salida PIXm",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Parameters/ParametroEntradaIhe-PIXm"
        },
        "name" : "Parametros de entrada para la operación $ihe-pix",
        "description" : "Ejemplo de un recurso Parameter que sirve para realizar la busqueda de un paciente dentro del MPI con la operación [$ihe-pix](OperationDefinition-MPI.PIXm.pix.html).",
        "exampleCanonical" : "https://interoperabilidad.minsal.cl/fhir/ig/nid/StructureDefinition/ParametrosEntradaPixmMpi"
      },
      {
        "extension" : [
          {
        ...
        "reference" : {
          "reference" : "Parameters/ParametroEntradaIhe-PDQm"
        },
        "name" : "Parametros de entrada para la operación $match",
        ...
        "exampleCanonical" : "https://interoperabilidad.minsal.cl/fhir/ig/nid/StructureDefinition/ParametrosEntradaPDQmMpi"
      },
      {
        "extension" : [
          {
        ...
        "reference" : {
          "reference" : "Parameters/ParametroSalidaIhe-PIXm"
        },
        "name" : "Parametros de Salida para la operación $ihe-pix",
        ...
        "exampleCanonical" : "https://interoperabilidad.minsal.cl/fhir/ig/nid/StructureDefinition/ParametrosSalidaPixmMpi"
      },
      {
        "extension" : [
          {
