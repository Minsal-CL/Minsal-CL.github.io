...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSGrupoMarcas | *Version*:0.4.8 |
...
* Include all codes defined in [`https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSGrupoMarcas`](CodeSystem-CSGrupoMarcas.md)version 📦0.4.8
