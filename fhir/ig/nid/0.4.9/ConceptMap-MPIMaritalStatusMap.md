# Mapeo de estados civiles entre el ValueSet DEIS y el ValueSet MaritalStatus de FHIR - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.9
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ConceptMap/MPIMaritalStatusMap | *Version*:0.4.9 |
