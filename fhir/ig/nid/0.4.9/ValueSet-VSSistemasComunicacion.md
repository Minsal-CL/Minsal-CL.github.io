# Medios de Comunicación con el Paciente - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.9

* [**Table of Contents**](toc.md)
* [**Artefactos Generados**](artifacts.md)
* **Medios de Comunicación con el Paciente**

## ValueSet: Medios de Comunicación con el Paciente 

| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSSistemasComunicacion | *Version*:0.4.9 |
| Active as of 2023-01-15 | *Computable Name*:VSSistemasComunicacion |

 
Este es un filtro del "system" del telecom del paciente solo para que se ocupen los indicados por normativa 
