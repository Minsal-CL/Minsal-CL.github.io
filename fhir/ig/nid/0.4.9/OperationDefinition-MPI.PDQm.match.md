# MPI PDQm $Match - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.9
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/OperationDefinition/MPI.PDQm.match | *Version*:0.4.9 | |
...
* **Use**: IN
  ...
  * **Scope**: 
  * **Cardinality**: 1..1
  * **Type**: [Patient](http://hl7.org/fhir/R4/patient.html)([MINSAL Paciente Busqueda](StructureDefinition-MINSALPacienteBusqueda.md))
  * **Binding**: 
...
* **Use**: OUT
  ...
  * **Scope**: 
  * **Cardinality**: 1..1
  * **Type**: [Bundle](http://hl7.org/fhir/R4/bundle.html)([MINSAL Bundle Resultado Operación Match](StructureDefinition-BundleSearchMPIMatch.md))
  * **Binding**: 
