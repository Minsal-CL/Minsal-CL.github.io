# Ejemplo de una Busqueda - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.9

* [**Table of Contents**](toc.md)
* [**Artefactos Generados**](artifacts.md)
* **Ejemplo de una Busqueda**

## Example Bundle: Ejemplo de una Busqueda

Profile: [MINSAL Bundle Resultado Consulta: Pacientes](StructureDefinition-BundleSearchMPI.md)

Bundle EjemploBusqueda of type searchset
