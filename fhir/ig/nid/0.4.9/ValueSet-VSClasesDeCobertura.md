# Clase de Cobertura de Salud - Núcleo de Interoperabilidad de Datos (NID) - MINSAL v0.4.9
...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSClasesDeCobertura | *Version*:0.4.9 |
...
* Include all codes defined in [`https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSClasesDeCobertura`](CodeSystem-CSClasesDeCobertura.md)version 📦0.4.9
