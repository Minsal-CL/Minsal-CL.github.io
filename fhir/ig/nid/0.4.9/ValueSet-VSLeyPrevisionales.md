...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSLeyPrevisionales | *Version*:0.4.9 |
...
* Include all codes defined in [`https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSLeyPrevisionales`](CodeSystem-CSLeyPrevisionales.md)version 📦0.4.9
