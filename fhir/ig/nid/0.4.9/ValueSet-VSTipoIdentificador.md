...
| | |
| :--- | :--- |
| *Official URL*:https://interoperabilidad.minsal.cl/fhir/ig/nid/ValueSet/VSTipoIdentificador | *Version*:0.4.9 |
...
* Include all codes defined in [`https://interoperabilidad.minsal.cl/fhir/ig/nid/CodeSystem/CSTipoIdentificador`](CodeSystem-CSTipoIdentificador.md)version 📦0.4.9
