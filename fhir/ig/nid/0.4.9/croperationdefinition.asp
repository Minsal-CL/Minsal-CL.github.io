...
<%
  ...
  if (s.indexOf("application/json+fhir") > -1) 
    ...
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.9/OperationDefinition-MPI.PDQm.match.html");
  else if (id == "MPI.PIXm.pix")
    Response.Redirect("https://interoperabilidad.minsal.cl/fhir/ig/nid/0.4.9/OperationDefinition-MPI.PIXm.pix.html");
  else if (id == "index")
...
<html>
<body>
Internal Error - unknown id <%= Request.QueryString("id") %> (from \0.4.9\croperationdefinition.asp) .
</body>
</html>
